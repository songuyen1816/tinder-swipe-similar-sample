...
export default class MainScreen extends Component {
    ...
    getFirstUser = async () => {
        return fetch(BASE_URL + "0.4/?randomapi")
            ...
            .then((responseJson) => {
                this.setState({
                    currentUser: responseJson.results[0].user,
                })
    ...
    getNewUser = async () => {
        return fetch(BASE_URL + "0.4/?randomapi")
            ...
            .then((responseJson) => {
                this.setState({
                    secondUser: responseJson.results[0].user,
                })
                ...
                <SafeAreaView style={{flex: 1}}>
                    ...
                    <View style={style.Wrapper}>
                        ...
                        <View style={[{
                            ...
                            <Image style={{width: 180, height: 60, marginTop: 50}}/>
                        </View>
                        ...
                        <View style={[style.CenterPanel]}>
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity style={{width: 60, height: 60, marginBottom: 50}} onPress={() => {
                                    this.goToFavorite()
                                }}>
        ...
        if (this.props.user != null) {
            ...
            return (
                <Animated.View
                    ...
                    <Animated.View
                        style={{opacity: this.likeOpacity, position: 'absolute', top: 5, left: 15, zIndex: 1000}}>
                        <Text style={{color: 'green', fontSize: 25, fontWeight: '800', padding: 10}}>LIKE</Text>
                    </Animated.View>

                    <Animated.View
                        style={{opacity: this.nopeOpacity, position: 'absolute', top: 5, right: 15, zIndex: 1000}}>
                    ...
                    <View style={{
                        ...
                        <Image style={{width: 170, height: 170, borderRadius: 170 * 2}}
                    ...
                    <View style={[{
                        ...
                        <View style={{
                            ...
                            <TabIcon tabType={TabType.BIRTHDAY} isSelected={this.state.currentTab === TabType.BIRTHDAY}
                                     parent={this}/>
                            <TabIcon tabType={TabType.ADDRESS} isSelected={this.state.currentTab === TabType.ADDRESS}
                                     parent={this}/>
                            <TabIcon tabType={TabType.ABOUT} isSelected={this.state.currentTab === TabType.ABOUT}
                                     parent={this}/>
                            <TabIcon tabType={TabType.PHONE} isSelected={this.state.currentTab === TabType.PHONE}
                                     parent={this}/>
                            <TabIcon tabType={TabType.ACCOUNT} isSelected={this.state.currentTab === TabType.ACCOUNT}
                                     parent={this}/>
                        </View>
                    </View>
                </Animated.View>
...
class TabIcon extends Component {
    ...
    renderImage() {
        ...
        switch (this.props.tabType) {
            case TabType.ABOUT:
                imgSource = this.props.isSelected ? tab_avatar_select : tab_avatar_unselect
                break
            case TabType.ACCOUNT:
                imgSource = this.props.isSelected ? tab_account_select : tab_account_unselect
                break
            case TabType.ADDRESS:
                imgSource = this.props.isSelected ? tab_place_select : tab_place_unselect
                break
            case TabType.BIRTHDAY:
                imgSource = this.props.isSelected ? tab_calendar_select : tab_calendar_unselect
                break
            case TabType.PHONE:
                imgSource = this.props.isSelected ? tab_phone_select : tab_phone_unselect
                break
        }
